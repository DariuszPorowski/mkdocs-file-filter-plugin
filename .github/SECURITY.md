...
All participants in our project are expected to adhere to our [`Code of Conduct`](https://github.com/DariuszPorowski/mkdocs-file-filter-plugin/blob/main/.github/CODE_OF_CONDUCT.md). Furthermore, we expect everyone to treat each other respectfully and contribute to a positive and inclusive community.
